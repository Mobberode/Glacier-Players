...
execute if score #ExtToolsEnabled glacier_players.extensions matches 1 run function gpe_bnether_foods:mount/mount_tool_info with storage glacier_players.extensions
