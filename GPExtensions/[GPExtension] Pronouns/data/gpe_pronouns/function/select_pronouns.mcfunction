##If already exists
execute if data storage glacier_players:macro instance.data.visual.pronoun run return run function gpe_pronouns:reapply
##Else
...
data modify storage glacier_players:macro instance.data.visual.pronoun set from storage gpe_pronouns:macro pronoun
