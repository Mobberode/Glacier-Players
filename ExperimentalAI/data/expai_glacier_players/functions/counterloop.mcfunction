...
title @a actionbar ["",{"text": "Real Players: "},{"score":{"name": "#PlayerCounter","objective": "expai_glacier_players.pid"}},{"text": " | Glacier Players (BOT): "},{"score":{"name": "#FakePlayerCounter","objective": "expai_glacier_players.pid"}},{"text": " | Destination Markers: "},{"score":{"name": "#MarkerCounter","objective": "expai_glacier_players.pid"}},{"text": " | GP Villagers: "},{"score":{"name": "#GPVillagersCounter","objective": "expai_glacier_players.pid"}}]
