...
item replace entity @s hotbar.7 with minecraft:red_candle[food={saturation:0,nutrition:0,eat_seconds:32000,can_always_eat:true},minecraft:custom_data={"gp.debug_off":true},minecraft:custom_name='{"text":"Toggle Debug Mode","color":"red"}']
