#execute at @e[type=marker] at @s run particle angry_villager ~ ~ ~ 0 0 0 0 1 force @a[tag=expai.debug]
...
execute as @a[tag=!expai_glacier_players.processed_id] run function expai_glacier_players:player/pid/begin_id_assign