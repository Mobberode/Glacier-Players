...
execute at @s[tag=!GlacierPlayer.Pickup_Delayed] if entity @e[type=item,distance=0..2] run function expai_glacier_players:player/inventory/inventory_gather with storage expai_glacier_players.macro
##Switch HandItems
