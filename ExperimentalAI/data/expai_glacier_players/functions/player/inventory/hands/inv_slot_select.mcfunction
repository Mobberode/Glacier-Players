...
#execute if score @s expai_glacier_players.rng matches 1 run execute store result storage expai_glacier_players.inventory_macro item_select_hand int 1 run random value 0..14
#execute if score @s expai_glacier_players.rng matches 1 run execute store result storage expai_glacier_players.inventory_macro item_select_hand int 1 run random value 0..11
