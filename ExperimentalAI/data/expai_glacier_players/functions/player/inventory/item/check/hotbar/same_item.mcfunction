...
tellraw @a ["",{"score":{"name": "@s","objective": "expai_glacier_players.inventory_slot_count"},"color": "gold"},{"score":{"name": "@s","objective": "expai_glacier_players.inventory_slot_comparing_count"},"color": "yellow"}]
...
execute if score @s expai_glacier_players.inventory_slot_comparing_count >= @s expai_glacier_players.inventory_item_max_stack_size run say stack limit reached!
