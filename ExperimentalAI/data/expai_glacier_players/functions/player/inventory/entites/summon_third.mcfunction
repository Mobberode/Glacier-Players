tag @e[tag=GlacierPlayer.Player_Selected] add GlacierPlayer.Third_Inventory_Summoned
tag @e[tag=GlacierPlayer.Player_Selected] add GlacierPlayer.Full_Inventory_Summoned
