##Randomise
execute store result score @s expai_glacier_players.mode run random value 1..4
...
execute if score @s expai_glacier_players.mode matches 3 run function expai_glacier_players:player/modes/creative/set_mode_time
##Gathering Mode
execute if score @s expai_glacier_players.mode matches 4 run function expai_glacier_players:player/modes/gathering/set_mode_time
##Combative Mode
