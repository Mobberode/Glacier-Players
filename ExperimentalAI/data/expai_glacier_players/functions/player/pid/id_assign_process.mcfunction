...
#Give ID if free
$execute unless entity @e[tag=gp.id$(playerid),limit=1] run function expai_glacier_players:player/pid/id_give_check with storage minecraft:glacier_pid.macro
