...
kill @e[type=item,nbt={Age:0s,Item:{id:"minecraft:chest"}},limit=3]
...
$summon donkey ~ ~ ~ {Invulnerable:true,Silent:true,Tags:["GP.$(respawning_id).InvSection1","GP_Inv.$(respawning_id)","expai_ai_changes_disabled"],NoAI:true,ChestedHorse:true,Attributes:[{Name:generic.scale,Base:0.1}],DeathLootTable:"minecraft:empty"}
$summon donkey ~ ~ ~ {Invulnerable:true,Silent:true,Tags:["GP.$(respawning_id).InvSection2","GP_Inv.$(respawning_id)","expai_ai_changes_disabled"],NoAI:true,ChestedHorse:true,Attributes:[{Name:generic.scale,Base:0.1}],DeathLootTable:"minecraft:empty"}
$summon donkey ~ ~ ~ {Invulnerable:true,Silent:true,Tags:["GP.$(respawning_id).InvSection3","GP_Inv.$(respawning_id)","expai_ai_changes_disabled"],NoAI:true,ChestedHorse:true,Attributes:[{Name:generic.scale,Base:0.1}],DeathLootTable:"minecraft:empty"}