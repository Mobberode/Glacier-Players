...
$summon armor_stand ~ ~ ~ {CustomName:'{"text":"$(respawning_name)"}',CustomNameVisible:true,PersistenceRequired:true,Tags:["GlacierPlayer"],Silent:true,Invulnerable:true,ShowArms:true}
