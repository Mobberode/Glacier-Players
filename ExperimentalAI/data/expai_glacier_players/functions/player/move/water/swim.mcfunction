...
execute rotated as @s as @e[tag=marker_motion,limit=1,sort=nearest] positioned 0.0 0.0 0.0 run function expai_glacier_players:player/motion/inwater/swim with storage expai_glacier_players.macro
