...
execute if score #Voiceline expai_glacier_players.rng matches 1 run playsound glacier_sounds:test_voice_line3 player @a ~ ~ ~ 3.5 1 0.5
...
execute if score #Voiceline expai_glacier_players.rng matches 2 run playsound glacier_sounds:test_voice_line4 player @a ~ ~ ~ 3.5 1 0.5
...
execute if score #Voiceline expai_glacier_players.rng matches 3 run playsound glacier_sounds:test_voice_line5 player @a ~ ~ ~ 3.5 1 0.5
...
execute if score #Voiceline expai_glacier_players.rng matches 4 run playsound glacier_sounds:test_voice_line6 player @a ~ ~ ~ 3.5 1 0.5
...
execute if score #Voiceline expai_glacier_players.rng matches 5 run playsound glacier_sounds:test_voice_line7 player @a ~ ~ ~ 3.5 1 0.5
...
execute if score #Voiceline expai_glacier_players.rng matches 6 run playsound glacier_sounds:test_voice_line8 player @a ~ ~ ~ 3.5 1 0.5
...
execute if score #Voiceline expai_glacier_players.rng matches 7 run playsound glacier_sounds:test_voice_line9 player @a ~ ~ ~ 3.5 1 0.5
...
execute if score #Voiceline expai_glacier_players.rng matches 8 run playsound glacier_sounds:test_voice_line10 player @a ~ ~ ~ 3.5 1 0.5
...
execute if score #Voiceline expai_glacier_players.rng matches 9 run playsound glacier_sounds:test_voice_line11 player @a ~ ~ ~ 3.5 1 0.5
...
execute if score #Voiceline expai_glacier_players.rng matches 10 run playsound glacier_sounds:test_voice_line12 player @a ~ ~ ~ 3.5 1 0.5
...
execute if score #Voiceline expai_glacier_players.rng matches 11 run playsound glacier_sounds:test_voice_line13 player @a ~ ~ ~ 3.5 1 0.5
...
execute if score #Voiceline expai_glacier_players.rng matches 12 run playsound glacier_sounds:test_voice_line14 player @a ~ ~ ~ 3.5 1 0.5
...
execute if score #Voiceline expai_glacier_players.rng matches 13 run playsound glacier_sounds:test_voice_line15 player @a ~ ~ ~ 3.5 1 0.5
...
execute if score #Voiceline expai_glacier_players.rng matches 14 run playsound glacier_sounds:test_voice_line16 player @a ~ ~ ~ 3.5 1 0.5
