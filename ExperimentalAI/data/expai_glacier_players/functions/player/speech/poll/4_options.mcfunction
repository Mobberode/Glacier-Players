execute store result score @s expai_glacier_players.poll_decision run random value 0..4
...
execute if score @s expai_glacier_players.poll_decision matches 3 run tellraw @a ["",{"selector":"@s","color": "gold"},{"text": " Picked "},{"text": "Option 3!","color": "gold"}]
execute if score @s expai_glacier_players.poll_decision matches 4 run tellraw @a ["",{"selector":"@s","color": "gold"},{"text": " Picked "},{"text": "Option 4!","color": "gold"}]
