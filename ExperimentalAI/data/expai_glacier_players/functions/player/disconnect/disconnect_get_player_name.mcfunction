...
execute store result storage expai_glacier_players.macro dissconnect_marker_destinations_id int 1 run scoreboard players get @s expai_glacier_players.pid
