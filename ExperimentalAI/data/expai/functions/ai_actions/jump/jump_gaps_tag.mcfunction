...
execute if score @s[tag=!expai.jump_roofed] expai.jump_gap_length matches 5..6 run say expai.sprint_jump_gap
execute if score @s[tag=!expai.jump_roofed] expai.jump_gap_length matches 7..8 run say expai.farther_sprint_jump_gap
