...
## Output:
##    storage dnt:ram out
## This function turns all letters from the input list into lowercase, including Full width letters, then concat it.
...
scoreboard players set $process calc.dnt 6
