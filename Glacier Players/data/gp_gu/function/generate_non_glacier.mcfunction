...
execute unless score @s gu.uuid.0 matches -2147483648.. run function gp_gu:zzz/store_uuid
...
function gp_gu:zzz/get_hexes with storage gu:temp
function gp_gu:zzz/concat_uuid_non_glacier with storage gu:temp