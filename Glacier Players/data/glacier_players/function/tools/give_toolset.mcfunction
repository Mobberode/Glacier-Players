...
item replace entity @s[tag=!expai.debug] hotbar.7 with minecraft:red_candle[food={saturation:0,nutrition:0,eat_seconds:32000,can_always_eat:true},minecraft:custom_data={"gp.debug_off":true},minecraft:custom_name='{"text":"Toggle Debug Mode","color":"red"}']
item replace entity @s[tag=expai.debug] hotbar.7 with minecraft:green_candle[food={saturation:0,nutrition:0,eat_seconds:32000,can_always_eat:true},minecraft:custom_data={"gp.debug_on":true},minecraft:custom_name='{"text":"Toggle Debug Mode","color":"green"}']
