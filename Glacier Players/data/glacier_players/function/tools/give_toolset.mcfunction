...
item replace entity @s hotbar.7 with minecraft:anvil[food={saturation:0,nutrition:0,eat_seconds:32000,can_always_eat:true},minecraft:custom_data={"gp.tbe":true},minecraft:custom_name='{"text":"Toolboxed Extensions","color":"aqua"}',enchantment_glint_override=true]
