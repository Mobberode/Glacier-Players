...
item replace entity @s hotbar.2 with minecraft:skeleton_skull[food={saturation:0,nutrition:0,eat_seconds:32000,can_always_eat:true},minecraft:custom_data={"gp.killer":true},minecraft:custom_name='{"text":"Kill Glacier Player","color":"red"}']
