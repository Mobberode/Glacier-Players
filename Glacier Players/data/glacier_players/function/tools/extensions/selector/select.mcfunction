...
##Override some slots
item replace entity @s hotbar.0 with minecraft:jigsaw[food={saturation:0,nutrition:0,eat_seconds:32000,can_always_eat:true},minecraft:custom_data={"gp.ext_previous":true},minecraft:custom_name='{"text":"Previous Extension Toolset","color":"gold"}']
item replace entity @s hotbar.8 with minecraft:jigsaw[food={saturation:0,nutrition:0,eat_seconds:32000,can_always_eat:true},minecraft:custom_data={"gp.ext_next":true},minecraft:custom_name='{"text":"Next Extension Toolset","color":"gold"}']
