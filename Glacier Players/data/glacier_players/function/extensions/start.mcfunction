...
execute store result storage glacier_players.extensions ext_response_lines_count int 1 run scoreboard players set #IdleLines glacier_players.extensions 0
execute store result storage glacier_players.extensions ext_panic_lines_count int 1 run scoreboard players set #IdleLines glacier_players.extensions 20
