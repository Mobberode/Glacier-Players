data remove storage glacier_players:visual_macro line.connect[{filters:{swearing:true}}]

data remove storage glacier_players:visual_macro line.disconnect[{filters:{swearing:true}}]
