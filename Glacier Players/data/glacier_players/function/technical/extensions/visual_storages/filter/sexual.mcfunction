data remove storage glacier_players.visual_macro line.connect[{filters:{sexual:true}}]

data remove storage glacier_players.visual_macro line.disconnect[{filters:{sexual:true}}]
