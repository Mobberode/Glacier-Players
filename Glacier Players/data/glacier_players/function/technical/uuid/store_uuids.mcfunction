data modify storage glacier_players:macro saved_inventory_uuid set value -1
data modify storage glacier_players:macro saved_inventory2_uuid set value -1

data modify storage glacier_players:macro saved_glacier_uuid set from storage glacier_players:temp_uuids saved.uuid
data modify storage glacier_players:macro saved_mannequin_uuid set from storage glacier_players:temp_uuids saved.mannequin
