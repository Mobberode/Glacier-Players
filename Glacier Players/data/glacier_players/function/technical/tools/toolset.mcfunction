...
item replace entity @s hotbar.1 with poisonous_potato[custom_data={gp_action:"event",gp_event_function:"glacier_players:technical/tools/configs/toolset"},custom_name={text:"Glacier Player Config",color:aqua},item_model=eye_armor_trim_smithing_template]
item replace entity @s hotbar.3 with poisonous_potato[custom_data={gp_action:"event",gp_event_function:"glacier_players:technical/tools/experimental/toolset"},custom_name={text:"Glacier Player Experimental",color:red},item_model=ominous_bottle]
