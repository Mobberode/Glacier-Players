...
item replace entity @s hotbar.0 with poisonous_potato[consumable={animation:none,consume_seconds:32000,has_consume_particles:false,sound:ui.button.click},use_cooldown={seconds:0.25,cooldown_group:gp.cooldown_disconnect_one},minecraft:custom_data={gp.disconnect_random:true},minecraft:custom_name={text:"Disconnect Random",color:red},item_model=red_dye]
item replace entity @s hotbar.1 with poisonous_potato[consumable={animation:none,consume_seconds:32000,has_consume_particles:false,sound:ui.button.click},use_cooldown={seconds:0.25,cooldown_group:gp.cooldown_disconnect_nearest},minecraft:custom_data={gp.disconnect_nearest:true},minecraft:custom_name={text:"Disconnect Nearest",color:red},item_model=red_dye]
item replace entity @s hotbar.2 with poisonous_potato[consumable={animation:none,consume_seconds:32000,has_consume_particles:false,sound:ui.button.click},use_cooldown={seconds:0.25,cooldown_group:gp.cooldown_disconnect_all},minecraft:custom_data={gp.disconnect_all:true},minecraft:custom_name={text:"Disconnect All",color:red},item_model=red_dye]
