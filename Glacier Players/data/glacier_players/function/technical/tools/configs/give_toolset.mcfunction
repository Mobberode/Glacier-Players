...
execute unless score #Permadeath glacier_players.config matches 1 run item replace entity @s hotbar.4 with minecraft:red_candle[food={saturation:0,nutrition:0,eat_seconds:32000,can_always_eat:true},minecraft:custom_data={"gp.config_permadeath":true},minecraft:custom_name='{"text":"Toggle Permadeath","color":"red"}']
execute if score #Permadeath glacier_players.config matches 1.. run item replace entity @s hotbar.4 with minecraft:green_candle[food={saturation:0,nutrition:0,eat_seconds:32000,can_always_eat:true},minecraft:custom_data={"gp.config_permadeath":true},minecraft:custom_name='{"text":"Toggle Permadeath","color":"green"}']
