...
item replace entity @s hotbar.2 with poisonous_potato[custom_data={gp_action:{type:event,function:"glacier_players:technical/tools/init/lock_disable"}},custom_name={text:"Lock and Disable Toolset",color:blue},item_model=blue_candle]
