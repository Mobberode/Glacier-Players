...
#Give ID if free
execute unless entity @n[type=armor_stand,predicate=glacier_players:id/check] run return run function glacier_players:technical/pid/id_give with storage glacier_pid.macro
