...
execute unless score @s gu.uuid.0 matches -2147483648.. run function glacier_players:technical/gu/zzz/store_uuid
...
function glacier_players:technical/gu/zzz/get_hexes with storage gu:temp
function glacier_players:technical/gu/zzz/concat_uuid with storage gu:temp