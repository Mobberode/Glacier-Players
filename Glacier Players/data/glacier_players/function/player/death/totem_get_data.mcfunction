...
execute store result score #HasAdditional glacier_players.has_undying_totem if items entity @e[type=donkey,tag=GlacierPlayer.Selected] horse.* totem_of_undying