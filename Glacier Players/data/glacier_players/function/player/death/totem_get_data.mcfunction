...
$execute if items entity @e[type=donkey,tag=GlacierPlayer.Selected] horse.* totem_of_undying as $(saved_glacier_uuid) run function glacier_players:player/inventory_reworked/item/modes/totem_check