...
##If XP exceeds 100
execute store result storage glacier_players:temp experience_amount_drop int 1 if score #Drop glacier_players.experience_amount matches 101.. run scoreboard players set #Drop glacier_players.experience_amount 100