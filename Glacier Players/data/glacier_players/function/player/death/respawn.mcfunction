...
##Respawn Player
summon armor_stand ~ ~ ~ {CustomNameVisible:true,Tags:["GlacierPlayer","glacier_players.processed_id","GP.DeathProcess"],Silent:true,Invulnerable:true,ShowArms:true,DisabledSlots:1,attributes:[{id:"scale",base:0.9113924}]}
