...
##Get
execute if score #KeepInventory glacier_players.condition matches 2 store result score #KeepInventory glacier_players.condition run gamerule keepInventory