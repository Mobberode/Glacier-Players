...
##Totem Detect
execute if items entity @s weapon.mainhand totem_of_undying run return run function glacier_players:player/inventory_reworked/equipment/apply/totem with storage glacier_players.macro
...
##Detect for armour
execute if items entity @s weapon.mainhand #glacier_players:armour/global run return run function glacier_players:player/inventory_reworked/equipment/armour/armour_check
