...
tellraw @a [{score:{name:"#Amount",objective:glacier_players.number},color:dark_aqua},{score:{name:"#CAmount",objective:glacier_players.number}}]
...
execute if score #Amount glacier_players.number matches ..0 run return run function glacier_players:player/inventory_reworked/equipment/apply/inv_change/merge_count
#Otherwise
function glacier_players:player/inventory_reworked/equipment/apply/inv_change/count_overflow