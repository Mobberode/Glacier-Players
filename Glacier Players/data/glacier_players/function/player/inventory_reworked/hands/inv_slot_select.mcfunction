...
execute if score @s glacier_players.inventory_player_hand matches 1 run function glacier_players:player/inventory_reworked/hands/select_main_hand with storage glacier_players.inventory_macro
execute if score @s glacier_players.inventory_player_hand matches 2 run function glacier_players:player/inventory_reworked/hands/select_off_hand with storage glacier_players.inventory_macro