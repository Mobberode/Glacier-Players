...
execute unless score @s glacier_players.inventory_item_max_stack_size matches 1.. run function glacier_players:player/inventory_reworked/item/internal/check/max_stack/get_max_stack_dynamic
