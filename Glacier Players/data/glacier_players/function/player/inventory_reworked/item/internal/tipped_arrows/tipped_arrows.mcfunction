...
##Run check
$execute unless data storage glacier_players.inventory_macro {potioneffect:'$(picked_potioneffect)'} run scoreboard players set #NextItem glacier_players.number 1
