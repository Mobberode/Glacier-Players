...
#Z
execute if score #Compare glacier_players.y_pos matches 2 if score #Compare glacier_players.z_pos matches 4 run setblock ^ ^ ^-.1 oak_log[axis=z]
execute if score #Compare glacier_players.y_pos matches 1 if score #Compare glacier_players.z_pos matches 3 run setblock ^ ^ ^-.1 oak_log[axis=z]