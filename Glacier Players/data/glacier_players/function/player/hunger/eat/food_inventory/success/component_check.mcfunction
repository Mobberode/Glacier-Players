...
##Fail (0)
execute if score #Components glacier_players.rng matches 0 as @e[limit=1,tag=GlacierPlayer.Player_Selected] run return run function glacier_players:player/hunger/eat/food_inventory/success/get/get_set_food_info with storage glacier_players.inventory_macro
##Success (1)
