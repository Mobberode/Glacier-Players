...
$execute as @n[tag=GP.Inventory_Selected.InvSection3] if items entity @s horse.$(player_inv_slot) *[food] run function glacier_players:player/hunger/eat/food_inventory/success/component_check with storage glacier_players.inventory_macro
