...
execute unless score @s glacier_players.inventory_slot_number matches 11.. if entity @s[tag=!GlacierPlayer.Inv_Sorted_Item] run function glacier_players:player/hunger/eat/food_inventory/inventory_2 with storage glacier_players.inventory_macro