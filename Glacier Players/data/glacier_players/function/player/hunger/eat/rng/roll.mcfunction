...
execute if score @s glacier_players.nutrition matches 7..11 run return run random value 125..500
execute if score @s glacier_players.nutrition matches 5..6 run return run random value 250..500
