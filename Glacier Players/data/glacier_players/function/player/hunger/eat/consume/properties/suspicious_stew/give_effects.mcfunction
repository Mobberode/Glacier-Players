...
##Loop
execute unless score #ProcessedStewEffects glacier_players.number >= #StewEffects glacier_players.number run function glacier_players:player/hunger/eat/consume/properties/suspicious_stew/give_effects with storage glacier_players.inventory_macro