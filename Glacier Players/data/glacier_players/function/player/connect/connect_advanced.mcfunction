...
$summon armor_stand ~ ~ ~ {CustomNameVisible:true,Tags:["GlacierPlayer","GP.Connecting"],Silent:true,Invulnerable:true,ShowArms:true,DisabledSlots:1,ArmorItems:[{},{},{},{count:1,id:player_head,components:{profile:{name:"$(connecting_name_head)"}}}]}
