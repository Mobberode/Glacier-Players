...
execute as @e[dx=0,limit=1,type=mannequin,tag=GlacierPlayer.Mannequin.Init] run function glacier_players:technical/uuid/store_mannequin with storage glacier_players:macro
