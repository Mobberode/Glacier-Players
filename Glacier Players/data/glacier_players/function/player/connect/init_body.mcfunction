...
$execute as @e[distance=0..1,limit=1,type=piglin_brute,tag=GP.$(pid_num)] run function glacier_players:technical/uuid/store_alias with storage glacier_players.macro
