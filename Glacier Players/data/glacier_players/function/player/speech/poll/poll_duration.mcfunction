...
execute if score #Timer glacier_players.poll_decision matches ..-1 run function glacier_players:player/speech/poll/poll_finish with storage glacier_players.macro
