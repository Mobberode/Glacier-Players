execute store result score @s glacier_players.poll_decision run random value 0..4
...
execute if score @s glacier_players.poll_decision matches 4 run tellraw @a ["",{"selector":"@s","color": "gold"},{"text": " Picked "},{"text": "Option 4!","color": "gold"}]
tag @s add glacier_players.voted_poll