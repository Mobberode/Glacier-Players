#X
data modify storage glacier_players:build_macro sequence_temp.data append value "axis=x"
...
#Y
data modify storage glacier_players:build_macro sequence_temp.data append value "axis=y"
...
#Z
data modify storage glacier_players:build_macro sequence_temp.data append value "axis=z"
