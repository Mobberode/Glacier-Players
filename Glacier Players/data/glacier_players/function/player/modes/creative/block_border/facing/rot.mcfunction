#Up and Down
data modify storage glacier_players:build_macro sequence_temp.data append value "facing=up"
execute if entity @s[type=marker,tag=GlacierPlayer.BlockBorder_Up] run return 0
data modify storage glacier_players:build_macro sequence_temp.data append value "facing=down"
...
#E
data modify storage glacier_players:build_macro sequence_temp.data append value "facing=east"
execute if score #PlaceRotation glacier_players.rotation matches 45..134 run return 2
#S
data modify storage glacier_players:build_macro sequence_temp.data append value "facing=south"
execute if score #PlaceRotation glacier_players.rotation matches -134..135 run return 3
#W
data modify storage glacier_players:build_macro sequence_temp.data append value "facing=west"
