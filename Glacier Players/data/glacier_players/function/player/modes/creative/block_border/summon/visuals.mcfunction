...
#Up and Down
summon marker ~.5 ~1 ~.5 {Tags:["GlacierPlayer.BlockBorder","GlacierPlayer.BlockBorder_Up"],Rotation:[0,-90]}
summon marker ~.5 ~ ~.5 {Tags:["GlacierPlayer.BlockBorder","GlacierPlayer.BlockBorder_Down"],Rotation:[0,90]}
