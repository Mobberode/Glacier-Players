...
execute if score #BuildRotation glacier_players.condition matches 3 run return run data modify storage glacier_players:temp build_rotation set value "facing=east"
execute if score #BuildRotation glacier_players.condition matches 4 run return run data modify storage glacier_players:temp build_rotation set value "facing=north"
