...
execute if score #RotationType glacier_players.condition matches 3 run return run function glacier_players:player/modes/creative/test_rot_check/fork2_bordercheck/orientation/get_data
#RotationType glacier_players.condition 4 = Rotation
execute if score #RotationType glacier_players.condition matches 4 run return run function glacier_players:player/modes/creative/test_rot_check/fork2_bordercheck/rotation/get_data