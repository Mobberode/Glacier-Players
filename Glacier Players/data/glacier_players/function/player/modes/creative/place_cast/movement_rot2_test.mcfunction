...
execute positioned as @s unless score @s glacier_players.cast_steps matches 51.. run function glacier_players:player/modes/creative/place_cast/movement_rot2_test