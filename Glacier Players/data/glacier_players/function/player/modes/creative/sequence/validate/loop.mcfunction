...
##Check
execute store result score #Test glacier_players.condition run function glacier_players:player/modes/creative/sequence/validate/check with storage glacier_players:build_macro

##Loop
#Failed
execute if score #Test glacier_players.condition matches 1 run return fail
#In-progress
