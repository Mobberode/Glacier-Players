...
#For players
$execute store result score #Pass glacier_players.condition positioned $(pos) as @p[tag=GP.Used_Place] run function glacier_players:player/modes/creative/space_check/run