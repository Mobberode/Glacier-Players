...
summon marker ~.73 ~.5 ~.0 {Tags:["GlacierPlayer.BlockBorder","GlacierPlayer.BlockBorder_N_NE"]}
summon marker ~.86 ~.5 ~.0 {Tags:["GlacierPlayer.BlockBorder","GlacierPlayer.BlockBorder_NE"]}
...
function glacier_players:player/modes/creative/test_rot_check/fork2_bordercheck/rotation/summon_debug_visuals