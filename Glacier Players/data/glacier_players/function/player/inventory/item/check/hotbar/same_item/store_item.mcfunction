...
#tellraw @a[tag=expai.debug] ["",{"score":{"name": "@s","objective": "glacier_players.inventory_slot_count"}},{"score":{"name": "@s","objective": "glacier_players.inventory_slot_comparing_count"},"color": "gray"}]
