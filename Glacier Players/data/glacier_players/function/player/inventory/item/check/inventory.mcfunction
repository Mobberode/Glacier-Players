...
execute unless score @s glacier_players.inventory_slot_number matches 15.. if entity @s[tag=!GlacierPlayer.Inv_Sorted_Item] run function glacier_players:player/inventory/item/check/inventory with storage glacier_players.inventory_macro