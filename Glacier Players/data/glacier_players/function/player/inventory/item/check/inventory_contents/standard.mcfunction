...
$execute if items entity @s horse.$(player_inv_slot) $(picked_item_id) run return run function glacier_players:player/inventory/item/check/success/same_item with storage glacier_players.inventory_macro
