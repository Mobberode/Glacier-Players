...
$execute unless score #DuplicateNotFound glacier_players.condition matches 1.. if items block 0 0 0 container.* $(item_convert_id) run function glacier_players:player/inventory/item/internal/check/success/same_item