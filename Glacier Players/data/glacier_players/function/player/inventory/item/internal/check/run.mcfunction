scoreboard players add @s glacier_players.inventory_slot_number 1
execute store result storage glacier_players:inventory_macro player_inv_slot int 1 run scoreboard players operation #Value glacier_players.inventory_saved_slot = @s glacier_players.inventory_slot_number
