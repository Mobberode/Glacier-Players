...
#Components
$execute unless data storage glacier_players.inventory_macro {components:$(picked_item_components)} run return run tag $(saved_glacier_uuid) add GlacierPlayer.Inv_Next_Item
