...
scoreboard players set #Stop glacier_players.inventory_slot_number 11
...
execute unless score #SortedItem glacier_players.condition matches 1 unless score #NoDrop glacier_players.config matches 1 run function glacier_players:player/inventory/item/partitions/no_space