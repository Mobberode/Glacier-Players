...
execute if entity @s[tag=GlacierPlayer.Inv_Booked] run function glacier_players:player/inventory/item/books/books_content with storage glacier_players.inventory_macro