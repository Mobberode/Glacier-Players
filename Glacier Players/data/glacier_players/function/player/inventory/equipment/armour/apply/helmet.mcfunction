...
$execute as $(saved_mannequin_uuid) run function glacier_players:player/inventory/equipment/armour/check/helmet
...
##Extensions
function #glacier_players:extensions/inventory/equipment/wore_helmet