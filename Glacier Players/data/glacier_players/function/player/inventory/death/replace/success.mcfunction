...
data modify entity @s Items[9] set from storage glacier_players.inventory_macro temp_item

##Apply to alias
data modify entity @n[type=piglin_brute,tag=GlacierPlayer.Abnormal_Selected] HandItems[1] set from storage glacier_players.inventory_macro temp_item
