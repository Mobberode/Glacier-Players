...
execute unless score @s glacier_players.inventory_slot_number matches 15.. if score #SortedItem glacier_players.condition matches ..0 run function glacier_players:player/inventory/death/replace/inventory