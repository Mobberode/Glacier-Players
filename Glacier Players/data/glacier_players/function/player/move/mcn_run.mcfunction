execute positioned ^ ^ ^0.5 unless block ~ ~.2 ~ #glacier_players:non_solids if block ~ ~1.2 ~ #glacier_players:non_solids if block ~ ~2.2 ~ #glacier_players:non_solids run tp ~ ~1 ~
