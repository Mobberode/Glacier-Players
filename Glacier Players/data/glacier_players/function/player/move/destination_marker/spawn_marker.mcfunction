...
execute as @e[limit=1,tag=GP.DMarker_Process] run function glacier_players:player/move/destination_marker/spawn_marker_final with storage glacier_players.macro