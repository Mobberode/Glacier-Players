...
execute unless block ^ ^.2 ^0.5 #glacier_players:non_solids if block ^ ^1.2 ^0.5 #glacier_players:non_solids if block ^ ^2.2 ^0.5 #glacier_players:non_solids run tp @s ^ ^1 ^
