...
execute rotated ~ 0 if score @s glacier_players.sub_mode matches 2 run function glacier_players:player/move/sprint
execute rotated ~ 0 if score @s glacier_players.sub_mode matches 3 run function glacier_players:player/move/sprint_jump
