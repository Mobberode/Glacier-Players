...
##Sub Mode
execute if score @s[tag=!glacier_players.cant_move,tag=glacier_players.summoned_dmarker] glacier_players.sub_mode matches 1.. run return run function glacier_players:player/move/movement_continue
