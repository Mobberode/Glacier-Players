##Check
#End early if near
execute if entity @n[distance=0..1.5,type=marker,tag=GlacierPlayer.DMarker_Selected] run return run function glacier_players:player/move/destination_marker/reached with storage glacier_players.macro
