##Randomise
execute store result score @s glacier_players.mode run random value 1..5
...
execute if score @s[scores={glacier_players.rule.can_build=1..}] glacier_players.mode matches 4 unless score #Build glacier_players.config matches 0 run function glacier_players:player/modes/creative/set_mode
##Gathering Mode
execute if score @s glacier_players.mode matches 5 unless score #Break glacier_players.config matches 0 run function glacier_players:player/modes/gathering/set_mode_time
##Combative Mode
