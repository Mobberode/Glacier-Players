...
execute if score @s glacier_players.mode matches 4 unless score #Build glacier_players.config matches 0 run function glacier_players:player/modes/creative/set_mode
##Gathering Mode
