...
data modify storage glacier_players:visual_macro startup.release set value 23
data modify storage glacier_players:visual_macro startup.version set value ["25w22a"]
