...
data modify storage glacier_players.visual_macro startup.release set value "20"
data modify storage glacier_players.visual_macro startup.version set value "25w09b"
