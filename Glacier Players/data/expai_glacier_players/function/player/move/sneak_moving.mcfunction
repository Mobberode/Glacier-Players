...
execute as @e[tag=marker_motion] positioned 0.0 0.0 0.0 run function expai_glacier_players:player/motion/sneaking with storage expai_glacier_players.macro
