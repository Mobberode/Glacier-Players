...
execute store result score @s[scores={expai_glacier_players.nutrition=6..7}] expai_glacier_players.rng run random value 25..500
execute store result score @s[scores={expai_glacier_players.nutrition=4..5}] expai_glacier_players.rng run random value 30..500
execute store result score @s[scores={expai_glacier_players.nutrition=2..3}] expai_glacier_players.rng run random value 35..500
execute store result score @s[scores={expai_glacier_players.nutrition=1}] expai_glacier_players.rng run random value 40..500
execute store result score @s[scores={expai_glacier_players.nutrition=0}] expai_glacier_players.rng run random value 50..500
