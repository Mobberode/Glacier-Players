...
scoreboard players set @e[tag=GlacierPlayer.Player_Selected] expai_glacier_players.food_eat_time 32
$execute store result score #ProcessEatTime expai_glacier_players.number run data get entity @s Items[$(player_inv_slot)].components.minecraft:food.eat_seconds
