...
$execute as @n[tag=GP.Inventory_Selected.InvSection3] if items entity @s horse.$(player_inv_slot) *[food] run function expai_glacier_players:player/hunger/eat/food_inventory/success/component_check with storage expai_glacier_players.inventory_macro
