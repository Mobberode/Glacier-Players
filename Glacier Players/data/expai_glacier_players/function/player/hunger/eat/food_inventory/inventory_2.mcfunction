msg @a[tag=expai.debug] ran inv food check 2
##Check Item
...
$execute as @e[limit=1,tag=GP.Inventory_Selected.InvSection3] if items entity @s horse.$(player_inv_slot) *[food] run function expai_glacier_players:player/hunger/eat/food_inventory/success/get_food_components with storage expai_glacier_players.inventory_macro
