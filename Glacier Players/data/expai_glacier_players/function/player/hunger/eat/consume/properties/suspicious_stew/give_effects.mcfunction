...
##Give Effects
execute as @n[tag=GlacierPlayer.Player_Selected] run function expai_glacier_players:player/hunger/eat/consume/properties/suspicious_stew/effect with storage expai_glacier_players.inventory_macro
