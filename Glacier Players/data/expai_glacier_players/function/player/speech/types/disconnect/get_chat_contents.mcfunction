...
$execute store result score #ChatContentType expai_glacier_players.rng run random value 1..$(ext_disconnect_lines_count)
...
scoreboard players remove #ChatContentType expai_glacier_players.rng 35
function #expai_glacier_players:extensions/speech/text/get_disconnect_contents
