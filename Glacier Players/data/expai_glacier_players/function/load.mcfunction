...
scoreboard objectives add expai_glacier_players.inventory_saved_slot dummy
scoreboard objectives add expai_glacier_players.inventory_saved_partition dummy
...
execute as @a run function #expai_glacier_players:initalize