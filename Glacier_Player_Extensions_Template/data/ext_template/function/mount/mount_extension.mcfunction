...
execute if score #ExtToolsEnabled glacier_players.extensions matches 1 run function ext_template:mount/mount_tool_info with storage glacier_players.extensions
